...
public class BuildingGhost : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        transform.rotation = Quaternion.Lerp(transform.rotation, BuildingManager.Instance.GetPlacedObjectRotation(), Time.deltaTime * 10f);
    }
    ...
    private void RefreshVisual()
    {
        ...
        {
            visual = Instantiate(placedObjectTypeSO.visualForGhostPlacedObject, Vector3.zero, Quaternion.identity);
            ...
            visual.localPosition = new Vector3(0, BuildingManager.Instance.currentBlockPrefab.transform.position.y - BlockPrefab.Offset.y -1, 0);
